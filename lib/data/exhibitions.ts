...
export const exhibitions: Exhibition[] = [
  // === UPCOMING ===
  {
    ...
    verseSeriesUrl: "https://verse.works/series/split-logic-by-ricky-retouch",
    status: "current",
    ...
    description: [
      ...
      "The pieces carry traces of vector displays, terminal interfaces, and certain visual languages associated with 1970s science fiction. Depth emerges through luminous points, interference patterns, and shifting densities rather than realism. The use of Helvetica and Akzidenz-Grotesk reinforces that technical lineage without turning nostalgic. These references feel absorbed into the broader visual texture of contemporary computational culture, where older interface systems continue to echo through present-day image making.",
    ...
    exploreArtworks: [
      {
        ...
        video: "/images/perfectl00p/trails-cult-ritual.mp4",
      ...
      },
      {
        ...
        video: "/images/perfectl00p/trails-copy.mp4",
      ...
      },
      {
        ...
        video: "/images/perfectl00p/trails-circuit-wars.mp4",
  ...
  },
  {
    ...
    details: {
      ...
      sourceVideo: "/images/earthsample/gwanak-gu-kelp.mp4",
      title: "kelp",
